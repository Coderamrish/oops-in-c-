...
Constraints:
0  ≤ n  ≤ 106
GFG POTD - Easy 402 18th may, 2026
Dynamic problem can use to solve it or Recursion is also but brute force approach
...
int main() {
    int n = 12;
    cout << "Maximum sum for n = " << n << " is: " << maxSum(n) << endl;
    n = 24;
    cout << "Maximum sum for n = " << n << " is: " << maxSum(n) << endl;
    return 0;
}
